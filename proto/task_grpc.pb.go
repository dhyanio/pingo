...
const (
	TaskManager_SubmitTask_FullMethodName = "/pingo.TaskManager/SubmitTask"
)
...
func (c *taskManagerClient) SubmitTask(ctx context.Context, in *SubmitTaskRequest, opts ...grpc.CallOption) (*SubmitTaskResponse, error) {
...
func (UnimplementedTaskManagerServer) SubmitTask(context.Context, *SubmitTaskRequest) (*SubmitTaskResponse, error) {
...
func _TaskManager_SubmitTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskManagerServer).SubmitTask(ctx, req.(*SubmitTaskRequest))
	}
